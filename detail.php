...
//notificacion
$preference->notification_url = "https://ed-mp-commerce-php.herokuapp.com/notificacion.php" ;
 //back_url
 $preference->back_urls = array(
    "success" => "https://ed-mp-commerce-php.herokuapp.com/success.php",
    "failure" => "https://ed-mp-commerce-php.herokuapp.com/failure.php",
    "pending" => "https://ed-mp-commerce-php.herokuapp.com/pending.php"
);   
$preference->save();
?>
<!DOCTYPE html>
